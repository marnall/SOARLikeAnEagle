def Artifact_AddCEFField(artifact_id=None, cef_field_name=None, cef_field_value=None, **kwargs):
    """
    ...
    Args:
        ...
        cef_field_value: The value to store in the CEF field. If left empty, this will make a CEF field containing None
